import { ComponentWithCallback, MbxUiComponent, ComponentWithValue, ComponentWithIcon } from "../../../types/global";
/**
 ...
 */
export type CheckBoxProps = ComponentWithValue<boolean> & ComponentWithIcon & ComponentWithCallback<boolean>;
/**
