import { ComponentWithCallback, ComponentWithValue, GenericInputComponent, MbxUiComponent } from "../../../types/global";
 ...
 */
export type InputProps = GenericInputComponent & AutoResizableComponent & ComponentWithValue<string> & ComponentWithCallback;
/**
