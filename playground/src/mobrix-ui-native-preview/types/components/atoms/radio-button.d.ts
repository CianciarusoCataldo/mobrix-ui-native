import { ComponentWithCallback, ComponentWithValue, MbxUiComponent } from "../../../types/global";
/**
 ...
 */
export type RadioButtonProps = ComponentWithValue<boolean> & ComponentWithCallback<boolean> & {
