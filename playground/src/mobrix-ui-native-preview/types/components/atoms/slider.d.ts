import { ComponentWithCallback, ComponentWithValue, MbxUiComponent, NumericInputComponent } from "../../../types/global";
/**
 ...
 */
export type SliderProps = ComponentWithValue<number> & ComponentWithCallback<number> & Omit<NumericInputComponent, "placeholder">;
/**
