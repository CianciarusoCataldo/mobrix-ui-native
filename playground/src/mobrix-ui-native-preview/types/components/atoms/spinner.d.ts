import { BuilderComponent, ComponentWithValue, MbxUiComponent } from "../../../types/global";
/**
 ...
 * @copyright 2024 Cataldo Cianciaruso
 */
export type SpinnerComponent<T extends string = string> = MbxUiComponent<SpinnerProps<T>>;
