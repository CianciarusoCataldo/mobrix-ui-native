import { BuilderComponent, ComponentWithCallback, ComponentWithIcon, ComponentWithValue, MbxUiComponent } from "../../../types/global";
/**
 ...
 */
export type ToggleProps = ComponentWithValue<boolean> & ComponentWithIcon & ComponentWithCallback<boolean> & {
