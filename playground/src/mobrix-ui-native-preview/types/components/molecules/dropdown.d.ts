import { BuilderComponent, ComponentWithCallback, ComponentWithValue, MbxUiComponent } from "../../../types/global";
/**
 ...
 */
export type DropdownProps = ComponentWithValue<number> & ComponentWithCallback<number> & {
    /** Dropdown elements */
