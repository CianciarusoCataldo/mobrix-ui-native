import { MbxSharedProps, ComponentWithCallback, ComponentWithValue, MbxUiComponent } from "../../../types/global";
 ...
 * @copyright 2024 Cataldo Cianciaruso
 */
export type RadioButtonGroupProps = ComponentWithCallback<number> & ComponentWithValue<number> & {
 ...
 * @copyright 2024 Cataldo Cianciaruso
 */
export type RadioButtonGroupComponent = MbxUiComponent<RadioButtonGroupProps>;
