import { BuilderComponent, ClosableComponent, ComponentWithChildren, MbxUiComponent } from "../../../types/global";
/**
 ...
 */
export type DrawerProps = ComponentWithChildren<BuilderComponent | BuilderComponent[]> & ClosableComponent & {
    /** Drawer position, relative to the entire window */
    position?: "right" | "left" | "top" | "bottom" | "top-left" | "top-right" | "bottom-left" | "bottom-right";
