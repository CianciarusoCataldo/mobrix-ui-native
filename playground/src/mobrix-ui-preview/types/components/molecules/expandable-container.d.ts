import { BuilderComponent, ComponentWithCallback, MbxUiComponent } from "../../../types/global";
 ...
 */
export type ExpandableContainerProps = ContainerProps & ComponentWithCallback<boolean> & {
 ...
 * @copyright 2024 Cataldo Cianciaruso
 */
export type ExpandableContainerComponent = MbxUiComponent<ExpandableContainerProps>;
