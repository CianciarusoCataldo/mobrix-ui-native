import { ComponentWithCallback, ComponentWithValue, DeepPartial, MbxUiComponent } from "../../../types/global";
/**
 ...
 * @copyright 2024 Cataldo Cianciaruso
 */
export type CalendarProps = ComponentWithValue<DeepPartial<CalendarDate>> & ComponentWithCallback<CalendarDate> & CalendarSharedProps & {
