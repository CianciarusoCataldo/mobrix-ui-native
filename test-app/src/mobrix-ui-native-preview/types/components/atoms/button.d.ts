import { BuilderComponent, ClickableComponent, ComponentWithChildren, MbxUiComponent } from "../../../types/global";
/**
 ...
 * */
export type ButtonProps = ComponentWithChildren<BuilderComponent | BuilderComponent[]> & ClickableComponent & {
