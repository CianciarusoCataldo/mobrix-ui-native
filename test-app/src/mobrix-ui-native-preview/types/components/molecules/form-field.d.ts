import { BuilderComponent, MbxSharedProps, ComponentWithCallback, ComponentWithValue, MbxUiComponent } from "../../global";
/**
...
export type FormFieldProps<T = any> = ComponentWithValue & ComponentWithCallback<T> & {
     ...
     */
    type?: "boolean" | "text" | "numeric" | "radio" | "checkbox" | "toggle" | "rater" | "slider" | "input" | "counter" | "password";
