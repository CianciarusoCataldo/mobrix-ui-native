import { BuilderComponent, ComponentWithChildren, MbxUiComponent } from "../../../types/global";
/**
 ...
 */
export type PopupProps = ComponentWithChildren<BuilderComponent | BuilderComponent[]>;
