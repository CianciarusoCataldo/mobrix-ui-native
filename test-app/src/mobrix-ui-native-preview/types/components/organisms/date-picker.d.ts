import { ClosableComponent, MbxSharedProps, ComponentWithCallback, ComponentWithValue, MbxUiComponent } from "../../../types/global";
 ...
 */
export type DatePickerProps = ComponentWithCallback<CalendarDate> & ComponentWithValue<CalendarDate> & ClosableComponent & CalendarProps & {
